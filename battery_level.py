...
def make_text_image(text_to_draw, x, y, font=None):
   ...
   '''
    ...
    # draw the text
    dc.text((x, y), text_to_draw, fill=(0, 128, 128, 1), font=font)
...
text_to_draw = ("{:.4}".format(battery_state.battery_volts))
text_to_draw2 = ("Hello world")
...
with anki_vector.Robot(args.serial) as robot:
    ...
    str = text_to_draw + " volts"
    robot.behavior.say_text(str)
    #time.sleep(5)
